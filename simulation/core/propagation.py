...
class ShoreParams:
    ...
    demo constants. Never real lat/lon; always the same 3-term-sine shape
    `shore_x` expects.
...
class PropagationParams:
    ...
    # The fictional demo shoreline. Every downstream shore_x/is_land/
    # distance_to_coast_along_heading call reads this.
