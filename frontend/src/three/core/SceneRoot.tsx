...
import { DEFAULT_SHORE, headingVector } from "@/propagation/world";
...
export function SceneRoot({
  ...
  return (
    <Suspense fallback={null}>
      ...
      {dense ? (
        // Dense Coastal Profile: a generic instanced building field replaces
        // the forest (three/urban/DenseBuildingLayer.tsx).
        <DenseBuildingLayer structures={structures?.structures} getSnapshot={getSnapshot} shore={shore} />
      ) : (
