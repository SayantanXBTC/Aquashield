import { Disc, RadioTower } from "lucide-react";
 ...
 */
export function RunsPanel({ runs, recording, error, replayRunId, replayStatus, canRecord, onRecord, onReplay, onExitReplay }: RunsPanelProps) {
  return (
    <HudPanel
      id="runs"
      title="Recorded runs"
